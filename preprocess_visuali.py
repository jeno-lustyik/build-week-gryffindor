...
df = pd.read_csv(r'C:\Users\omolara\Documents\strive school\build-week-gryffindor\datagy.csv')
# print(df)
...
# plot the number of awards and ratings against title of books and compare if the award given goes in line with the rating 
